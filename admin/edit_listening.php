               ...
               <div class="row mt">
                <div class="col-lg-12">
                    <div class="text1">TOEFL Test - Listening,</div>
                     <form action="prosesedit_listening.php" method="post">
                    <table>
                        ...
                        <?php
                            $query=mysql_query("select * from listening where no='$no'");
                            if ($query) {
                            while ($row = mysql_fetch_array($query)) {
                                echo "
                                <tr>
                                ...
                                <tr><td>Part</td>
                                    <td><input type=\"text\" name=\"part\" value=\"".$row['part']."\" style=\"width:100px; height:60px;\"></td></tr>
                                <tr><td>A</td>
