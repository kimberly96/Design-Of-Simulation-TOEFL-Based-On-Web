...
<body>
	...
	<link rel="stylesheet" type="text/css" href="css/style.css">
        ...
        <div id="main-content">
            ...
            <div class="wrapper">
               <div class="row">
                    <div class="text1">TOEFL Test - Reading,</div>
                    <form id="list-form">
                    ...
                    <table class="table">
                        ...
                        $query = mysql_query("SELECT * FROM reading");
                        if ($query) {
                        while ($row = mysql_fetch_array($query)) {
                            echo "
                                <tr>
                                    ...
                                    <td>".$row['jawaban']."</td>
                                    <td>
                                        <a href=\"edit_reading.php?id=".$row['no']."\">Edit</a> |
                                        <a href=\"hapus_reading.php?id=".$row['no']."\">Delete</a>
                                    </td>
                                </tr>";
                    ...
                    <form id="tambah-form" method="POST" action="tambah_reading.php" style="display:none;">
                    ...
                    <tr>
                    <td><br>Bacaan</td>
                    <td id><br><textarea class="in" name="bacaan" cols="100" rows="6"></textarea></td>
                    </tr>
                    <tr>
                    <td><br>Pertanyaan</td>
