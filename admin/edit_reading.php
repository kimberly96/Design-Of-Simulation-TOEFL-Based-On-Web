               ...
               <div class="row mt">
                <div class="col-lg-12">
                    <div class="text1">TOEFL Test - Reading,</div>
                     <form action="prosesedit_reading.php" method="post">
                    <table>
                        ...
                        <?php
                            $query=mysql_query("select * from reading where no='$no'");
                            if ($query) {
                            while ($row = mysql_fetch_array($query)) {
                                echo "
                                <tr>
                                ...
                                <tr><td>Readings</td>
                                    <td><input type=\"text\" name=\"bacaan\" value=\"".$row['bacaan']."\" style=\"width:900px; height:200px;\">
                                    </td></tr>
                                <tr><td>Question</td>
