      ...
      <h3>Adverbs Of <span>Frequency</span></h3>
         ...
         <div style="background-color:#666666; color:white; margin-left:150px; width:620px; padding:5px 0">There are 10 questions in this quiz. Read the grammar explanation below. 
          <div class="box3">
            ...
            <table border="10px" cellspacing="5px" width="580px">
              <?php if ($question<$max){ ?>
              <tr><td align="left">
                <form method="POST" name="question" action="">
                <strong><?php print $question+1; ?>. </strong><?php print "<b>".$a[$randval2][0]."</b>"; ?>
              ...
              <tr><td>
                ...
                Percentage of correct responses: <?php print $percentage; ?> %<br>
                <input type="hidden" name="response" value=0>
                <input type="hidden" name="question" value=<?php print $question; ?>>
                <input type="hidden" name="ok value"=<?php print $ok; ?>>
                <input type="hidden" name="Random" value=<?php print $randval; ?>>
                <?php print $question+1; ?> / <?php print $max; ?>
                <input style="font-family:Trebuchet ms; font-size:15px; margin-left:50px; width:80px; border:1px;" type="submit" value="Next"><br><br>
                ...
                ?>
                <tr><tr align="center">
                <center>You have completed the test. <br>
                Percentage of correct answer: <?php print $percentage; ?> %<br><br>
                <p><a href="<?php print $address; ?>" class="link">Restart</a></center>
                <?php } ?>
              </td></tr>
            </table>

            <form id="show-form">
            <a href="#" class="link" onclick="showPenjelasanForm()">Show Explanation</a><br><br><hr>
            </form>

            <form id="hide-form" style="display:none">
            <a href="#" class="link" onclick="showListForm()">Hide Explanation</a><br><br><hr>
            </form>
            ...
            <div class="text1">
              ...
              We visit our grandparents twice a month.<br></em>
